...
(library Library_1
	...
	(compDef "OPA1612AIDRGR" (originalName "OPA1612AIDRGR") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "8" (pinName "V+") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "OUT B") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "-IN B") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "+IN B") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<STEP Filename>" "OPA1612AIDRGR.stp")
